...
const dataProperty = propertyNamesOf<Data>()('deleteCategory');
...
const useCustomMutation = () => {
  ...
  useLoadingOverlay('Category delete mutation', loading, error);
...
export { useCustomMutation as useCategoryDelete };
