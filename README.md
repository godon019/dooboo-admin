...
[![CircleCI](https://circleci.com/gh/dooboolab/dooboo-admin.svg?style=svg)](https://circleci.com/gh/dooboolab/dooboo-admin)
[![codecov](https://codecov.io/gh/dooboolab/dooboo-admin/branch/master/graph/badge.svg)](https://codecov.io/gh/dooboolab/dooboo-admin)
...
6. [Know how to localize your project](https://github.com/dooboolab/dooboo-admin/blob/master/STRINGS.ts).

- [Example]()

7. [Know how to place your `retina image` into your project](https://github.com/dooboolab/dooboo-admin/blob/master/src/utils/Icons.ts).
8. Know how to use `styled-component`.
9. [Know how to implement theming with styled-component](https://github.com/dooboolab/dooboo-admin/blob/master/src/theme.ts).
...
> Create new tsx file with component name you will create
