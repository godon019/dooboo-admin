...
> Followed by `dooboolab.com`'s [CONTRIBUTING GUIDE](https://github.com/dooboolab/dooboolab.com/edit/master/contributing.md)
...
1. Fork our project to yours.
   ...
   - Configure [Syncing a fork](https://help.github.com/articles/configuring-a-remote-for-a-fork/).
     - `git remote add upstream https://github.com/dooboolab/dooboo-admin`
...
2. Git clone your forked repository.
   ```
   git clone https://github.com/<your-id>/dooboo-admin.git
   ```
